...
def background_thread():
    for message in consumer:
        ...
        socketio.emit('my_response', {'features': features, 'data': 'Features'}, namespace='/test')
        socketio.emit('my_resp', {'prediction': prediction, 'data': 'Power Prediction'}, namespace='/test')
        #count = 0
        #while True:
            #socketio.sleep(5)
            #features = argsdict
